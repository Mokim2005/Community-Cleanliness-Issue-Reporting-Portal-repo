              ...
              <tbody className="divide-y divide-white/5">
                {myIssus.length === 0 ? (
                  <tr>
                    <td
                      colSpan={4}
                      className="py-20 text-slate-500 font-bold uppercase tracking-widest text-sm italic"
                    >
                  ...
                  myIssus.map((issue) => (
                    ...
                    >
                      <td className="py-6 px-6 text-left">
                        ...
                        <span className="text-[10px] bg-secondary/10 text-secondary px-2 py-0.5 rounded font-black uppercase tracking-wider">
                          {issue.category}
                        </span>
                      </td>
                      <td className="py-6 px-6 text-white font-black">
                        ৳{issue.amount}
                      </td>
        ...
        {isEditModalOpen && selectedIssue && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div
              ...
              className="absolute inset-0 bg-[#050b18]/90 backdrop-blur-sm"
            />
            <motion.div
              ...
              <form onSubmit={handleUpdate} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full bg-white/5 border border-white/10 p-4 rounded-2xl text-white focus:border-secondary outline-none transition-all resize-none"
                    required
                  />
                </div>

                <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
                  <label className="font-bold text-slate-400 text-sm">
                    Report Status
                  </label>
                  <select
                    name="status"
                    defaultValue={selectedIssue?.status}
                    className="bg-secondary text-secondary-content font-black rounded-lg px-3 py-1 outline-none text-xs"
                  >
                ...
                <button
                  type="submit"
                  className="w-full py-5 bg-secondary text-secondary-content font-black rounded-2xl shadow-xl shadow-secondary/20 hover:scale-[1.02] transition-all uppercase tracking-widest text-sm"
                >
                  Save Changes
                </button>
              </form>
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 py-4 bg-red-500 text-white font-black rounded-2xl shadow-xl shadow-red-500/20 hover:scale-105 transition-all"
                >
                  Delete
                </button>
              </div>
